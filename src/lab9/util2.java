...
public class util2 {
    ...
    public static void monitorE(Supplys e, Products a, Providers с) {
        String[] menu = new String[]{"1 - вивести список;", "2 - детально про товар за номером поставки;", "3 - детально про поставщика за номером поставки;", "4 - створити новый заказ;", "5 - вилучити заказ за номером;", "6 - додати елемент з файла;", "7 - записати елемент у файл;", "8 - прочитати колекцiю з файла;", "9 - зберегти колекцiю у файлi;"};
        Repres tmpr = null;
        String s = null;
        Item tmpi1 = null;
