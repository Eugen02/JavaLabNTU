...
public abstract class Product implements Serializable, Item {
    private int id;
    private String name;
    private int amount;
    ...
    public int comp1(Product a) {
        return this.name.compareTo(a.getName());
    }

    public int comp2(Product a) {
        if (this.amount < a.getAmount()) {
            return -1;
        } else {
            return this.amount > a.getAmount() ? 1 : 0;
        }
    }
